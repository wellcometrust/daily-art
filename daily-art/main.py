...
from .resources.data import ArtWork, get_data, save_data_locally, convert_iiif_width
...
def flag_art(work_id: str = Path(..., description="The id of your work"), sensitivity: bool = False,
